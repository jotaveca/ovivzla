<?php
   ...
   $web = new ControlWeb();
    ...
    $total_usuarios_twitter = $web->obtenerTotalUsuarios();     
    $total_tuits_interes = $web->obtenerTotalTuitsInteres();
    $total_suscriptores = $web->obtenerTotalSuscriptores();
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Tuits analizados</span>
              <span class="info-box-number"><?=$total_tuits?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Tuits de interés clasificados</span>
              <span class="info-box-number"><?=$total_tuits_interes?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Usuarios de twitter analizados</span>
              <span class="info-box-number"><?=$total_usuarios_twitter?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$total_suscriptores?><small> usuarios</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left">Nikola Tesla</span>
