...
<script>
  ...
  function crearTablaAlertas(){

    $('#listado').hide();

    $.ajax({    
      url: "../../../src/adm_alertas.php?a=listar",      
    })
     .done(function( data, textStatus, jqXHR ) {
      if(data!="VACIO"){
        ...
        tabla+="<thead><tr>";
        tabla+="<th>Nombre alerta</th>";
        tabla+="<th>Clase alerta</th>";
        tabla+="<th>Tipo alerta vial</th>";
        tabla+="</tr></thead>";
        tabla+="<tbody>";
        ...
        for(i = 0; i < aLista.length; i++) {
            ...
            tabla+="<tr>";
            tabla+="<td>"+aLista[i].tx_nb_palabra_interes+"</td>";
            tabla+="<td>"+aLista[i].tx_clase_palabra_interes+"</td>";
            tabla+="<td>"+aLista[i].tx_tipo_palabra_interes+"</td>";        
            tabla+="</tr>";
