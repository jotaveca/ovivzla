        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Listado de Vias</h3>
            </div>
            <!-- /.box-header -->
...
<script>
  ...
  function crearTablaVias(){

    $('#listado').hide();

    $.ajax({    
      url: "../../../src/adm_vias.php",      
    })
     .done(function( data, textStatus, jqXHR ) {
      if(data!="VACIO"){
        ...
        for(i = 0; i < aLista.length; i++) {
            ...
            tabla+="<tr>";
            tabla+="<td>"+aLista[i].tx_nombre+"</td>";
            tabla+="<td>"+aLista[i].tx_siglas+"</td>";
            tabla+="<td>"+aLista[i].tx_estado+"</td>";
